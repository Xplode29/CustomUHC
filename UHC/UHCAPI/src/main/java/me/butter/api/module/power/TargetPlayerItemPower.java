...
public abstract class TargetPlayerItemPower extends ItemPower {

    int range;

    public TargetPlayerItemPower(String name, Material material, int range, int cooldown, int maxUses) {
