...
public class NinjagoModule implements Module {
    ...
    public String getDoc() {
        return "https://butteronpancakes.gitbook.io/ninjago-uhc-v2";
    }

    @Override
    public JavaPlugin getPlugin() {
        return NinjagoV2.getInstance();
    }
    ...
    public List<RoleType> getRoleComposition() {
        return NinjagoV2.getInstance().getRolesComposition();
    }

    @Override
    public List<Role> getRolesList() {
        return NinjagoV2.getInstance().getRolesList();
    }

    @Override
    public void setRolesList(List<Role> roles) {
        NinjagoV2.getInstance().setRolesList(roles);
    }
