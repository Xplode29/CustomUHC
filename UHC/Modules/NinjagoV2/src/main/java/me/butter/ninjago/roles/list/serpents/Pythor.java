...
public class Pythor extends NinjagoRole {
    ...
    private static class InvokeCommand extends CommandPower {
        ...
        public InvokeCommand() {
            ...
            this.goldenWeapons = NinjagoV2.getInstance().getGoldenWeaponManager().getWeapons().stream().map(AbstractGoldenWeapon::getItemStack).collect(Collectors.toList());
        }
        ...
        public boolean onEnable(UHCPlayer player, String[] args) {
            ...
            for(AbstractGoldenWeapon weapon : NinjagoV2.getInstance().getGoldenWeaponManager().getWeapons()) {
