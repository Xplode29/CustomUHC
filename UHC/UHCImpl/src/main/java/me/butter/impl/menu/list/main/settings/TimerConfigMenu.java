    ...
    public Map<Integer, Button> getButtons() {
        ...
        buttons.put(19, new ButtonImpl() {
            ...
            public void onClick(UHCPlayer player, ClickType clickType) {
                ...
                if(timer.getMaxTimer() < 60) {
                    timer.setMaxTimer(60);
                }
            }
        ...
        buttons.put(22, new ButtonImpl() {
            @Override
            public ItemStack getIcon() {
                return new ItemBuilder(timer.getIcon()).setName("§r" + timer.getName() + ": " + StringUtils.convertToAccurateTime(timer.getMaxTimer())).toItemStack();
            }
        });
